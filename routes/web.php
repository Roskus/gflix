...
Auth::routes();
Route::get('/profile', [\App\Http\Controllers\Profile\ProfileDetailController::class, 'detail'])
    ->name('profile')->middleware('auth');
Route::get('/{type}', [\App\Http\Controllers\CategoryController::class, 'index'])->middleware('auth')
